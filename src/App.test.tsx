...
describe('App', () => {
  ...
  it('runs in a DOM environment', () => {
    ...
    // Assert against the DOM realm's own constructor, not the test realm's
    // `Object`. jsdom elements are created in a separate realm, so
    // `toBeInstanceOf(Object)` is a cross-realm check that can be false while
    // the DOM is working perfectly — it passed under one vitest version and
    // failed under the next, which is the opposite of what this test is for.
